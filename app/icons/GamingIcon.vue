...
<template>
  ...
  >
    ...
    />
    <circle class="cls-2" cx="328.06" cy="228.14" r="8.09" />
    <circle class="cls-2" cx="328.06" cy="228.14" r="8.09" />
    <circle class="cls-2" cx="328.06" cy="260.51" r="8.09" />
    <circle class="cls-2" cx="344.24" cy="244.33" r="8.09" />
    <circle class="cls-2" cx="344.24" cy="244.33" r="8.09" />
    <circle class="cls-2" cx="311.87" cy="244.33" r="8.09" />
  </svg>
</template>
