...
export const data = {
    ...
    description: "<b>CTO</b> depuis 3+ ans au sein de Zenika Lyon, regroupant 50+ consultants.<br />Consultant frontend depuis 9+ ans, évoluant dans des applications grand public comme backoffice. Speaker dans des conférences comme Devoxx France ou DevFest Nantes Co-Organisateur du LyonJS. Formateur React, Vue, Node & JS.",
